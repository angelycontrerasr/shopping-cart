...
const Electronic = () => {
    ...
    const ProductCard = ({ product }) => (
        <div style={{fontFamily: 'monospace'  ,background: '#4662AF', border: '1px solid #ccc', margin: '10px', padding: '16px', width: '200px', borderRadius: '4rem'}}>
            {product.thumbnail && (
                <img
            ...
            <button style={{fontFamily: 'monospace' ,background: '#AAA', borderRadius: '10px'}} onClick={() => addToCart(product)}>
                Add to Cart
            </button>
        </div>
    );
    ...
    return (
        <div>
            ...
            <Link to="/" >
                <button style={{background: '#AAA', borderRadius: '10px', width: '8rem', height: '3rem'}}>Go Back</button>
            </Link>
